...
<style scoped>
  ...
  @font-face {
    ...
    src: url('/virtual-everest-climb/static/fonts/BalooThambi-Regular.ttf');
  }

  @font-face {
    font-family: 'Oxygen Mono';
    src: url('/virtual-everest-climb/static/fonts/OxygenMono-Regular.ttf');
  }

  @font-face {
    font-family: 'Jaldi';
    src: url('/virtual-everest-climb/static/fonts/Jaldi-Regular.ttf');
  }
